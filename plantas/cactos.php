...
<style>
    ...
    .product-image {
        height: 200px;
        background: linear-gradient(45deg, var(--secondary), #e0f0e0);
        position: relative;
        overflow: hidden;
        display: flex;
        align-items: center;
...
<section class="products-section">
    <div class="container">
        <div class="section-title">
            <h2><i class="fas fa-spa"></i> Nossos Cactos</h2>
            <p>Plantas resistentes e únicas, perfeitas para o clima paranaense</p>
        </div>
    ...
    <div class="container">
        ...
        <div class="tips-grid">
            <div class="tip-card">
                ...
                <h4>Luz Solar</h4>
                <p>6-8 horas de sol direto. No verão paranaense, permita sol pleno - cactos adoram calor!</p>
            </div>
            <div class="tip-card">
                <i class="fas fa-tint"></i>
                <h4>Rega</h4>
                <p>No inverno do PR, regue apenas 1x por mês. No verão, quando substrato estiver seco.</p>
            </div>
            <div class="tip-card">
                <i class="fas fa-thermometer-half"></i>
                <h4>Temperatura</h4>
                <p>Resistem bem ao frio, mas proteja de geadas intensas abaixo de 0°C.</p>
            </div>
            <div class="tip-card">
                <i class="fas fa-seedling"></i>
                <h4>Substrato</h4>
                <p>Drenagem essencial! Use 70% areia grossa + 30% terra comum. Evite encharcamento.</p>
            </div>
        </div>
    </div>
</section>
...
<script>
    ...
    const cactos = <?php echo json_encode($cactos, JSON_UNESCAPED_UNICODE); ?>;
    // Função para gerar mensagem do WhatsApp
    function generateWhatsAppMessage(product) {
        return `Olá! Tenho interesse no cacto ${product.name} (${product.scientific}) no valor de R$ ${product.price.toFixed(2)}. Gostaria de mais informações sobre cultivo no Paraná! Aguardo retorno!`;
    }
