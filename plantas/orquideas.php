...
require_once 'dados-orquideas.php';
?>
    ...
    <div class="container">
        ...
        <div class="tips-grid">
            <div class="tip-card">
                ...
                <h4>Iluminação</h4>
                <p>Luz indireta brilhante. Evite sol direto nas folhas - use sombrite 50% no verão paranaense.</p>
            </div>
            <div class="tip-card">
                <i class="fas fa-tint"></i>
                <h4>Irrigação</h4>
                <p>Regue quando substrato estiver quase seco. No inverno do PR, reduza para 1x por semana.</p>
            </div>
            <div class="tip-card">
                <i class="fas fa-thermometer-half"></i>
                <h4>Temperatura</h4>
                <p>Maioria prefere 15-25°C. Proteja do frio intenso abaixo de 10°C durante o inverno.</p>
            </div>
            <div class="tip-card">
                <i class="fas fa-seedling"></i>
                <h4>Substrato</h4>
                <p>Use casca de pinus, musgo e perlita. Nunca plante em terra comum - precisa drenar bem!</p>
            </div>
...
<script>
    ...
    const orquideas = <?php echo json_encode($orquideas, JSON_UNESCAPED_UNICODE); ?>;
